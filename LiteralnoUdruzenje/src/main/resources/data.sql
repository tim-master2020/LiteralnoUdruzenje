...
insert into users (id,firstname, lastname,username, email, password,last_password_reset_date,city,country,is_active_account,role)
values (-11,'pera', 'peric','pera', 'reservetableapp@gmail.com', '$2a$10$En99NVAv.YrTtVxJ1fssBeVO4AFnfl1OMwzFbPeaDdSBm1KLUzp12','2012-09-17 18:47:52.69','Novi Sad','Srbija',true,'EDITOR');
